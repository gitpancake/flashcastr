...
// City count badges reflecting 87 max territories (Invader's actual reach)
export const CITY_COUNT_BADGES: Badge[] = [
  ...
  },
  {
    id: "traveler",
    name: "Traveler",
    description: "3 different cities",
    icon: "/",
    threshold: 3,
    tier: "bronze",
    gradient: "from-green-600 to-green-400",
  },
  {
    id: "wanderer",
    name: "Wanderer",
    description: "7 different cities",
    icon: "\\",
    threshold: 7,
    tier: "silver",
    gradient: "from-green-500 to-green-300",
  },
  {
    id: "nomad",
    name: "Nomad",
    description: "15 different cities",
    icon: "^",
    threshold: 15,
    tier: "silver",
    gradient: "from-green-500 to-green-300",
  ...
  },
  {
    id: "world_invader",
    name: "World Invader",
    description: "70+ different cities",
    icon: "~",
    threshold: 70,
    tier: "diamond",
    gradient: "from-green-200 to-white",
